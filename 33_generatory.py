...
for i in range(9):                    # pętla for wykonująca się 10 razy
...
# zamiast i można użyć znaku "_", ponieważ zmienna i nie jest używana i python czegoś w tym miejscu wymaga
    print(next(y))

# zadanie dodatkowe

x = (5 * n for n in range(1,11))
