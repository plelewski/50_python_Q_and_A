...
def sprawdz_czy_palindrom1(slowo):
...
def sprawdz_czy_palindrom2(slowo):
...
def sprawdz_czy_palindrom3(slowo):
...
# wersja 2 powyżej jest najbardziej python'owa
print(sprawdz_czy_palindrom2("kajak"))
print(sprawdz_czy_palindrom2("anakonda"))
